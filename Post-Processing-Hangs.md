...
Below example commands to assist *nix users finding hung post-processing scripts. These examples assume you're using the PHP versions of the multi-threaded PP scripts. They're now recommended over the python versions.
