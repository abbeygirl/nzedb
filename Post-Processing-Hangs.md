...
Below example commands to assist *nix users finding hung post-processing scripts. These examples assume you're using the PHP versions of the multi-threaded PP scripts. These are now recommended over the python versions.
